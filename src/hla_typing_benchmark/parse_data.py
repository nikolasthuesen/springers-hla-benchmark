...
deleted_df = pd.read_csv('results/00_IMGT_reference/Deleted_alleles.txt', comment='#')
...
def make_p_group_dict(p_group_filepath='results/00_IMGT_reference/hla_nom_p.txt'):
